...
const MobileMenu: React.FC<MobileMenuProps> = ({ isOpen, navItems }) => (
  <motion.div
    ...
    className="md:hidden absolute top-full left-0 w-full bg-white border-t border-gray-200 shadow-2xl"
  >
      ...
      {navItems.map((item, index) => {
        ...
        return (
          <motion.a
            ...
            className="text-primary hover:text-secondary hover:bg-gray-50 block px-3 py-2 rounded-md text-base font-medium cursor-pointer"
          >
            {item}
          </motion.a>
        );
        ...
        whileInView={{ opacity: 1 }}
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                <a href="mailto:m.alsayh@wse.edu.sa" className="flex items-center gap-2 hover:text-secondary transition-colors">
                  <HiEnvelope className="text-xl" />
                 m.alsayh@wse.edu.sa
                </a>
                <a href="tel:+966532786532" className="flex items-center gap-2 hover:text-secondary transition-colors">
